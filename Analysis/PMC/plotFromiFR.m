...
function [hmp,psf,edf] = plotFromiFR(d,iFR,uSelect,plotting,pvis,yLim,TM)
...
stimWin(1,:) = [Events(1)-19 Events(1)+24];
timevec{1} = -1.9:binsize:diff(stimWin(1,:)*binsize)-1.9;
