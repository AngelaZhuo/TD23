function [trialmatrix] = ConstructTrialMatrix_TD23_excitation(chapter,ex_vectors_cur)
...
trialmatrix=table(trialmatrix(:,1), trialmatrix(:,2), trialmatrix(:,3), trialmatrix(:,4), trialmatrix(:,5), trialmatrix(:,6), trialmatrix(:,7), trialmatrix(:,8), 'VariableNames', {'odorcue_odor_num', 'odorcue_odor_dur', 'rewardcue_odor_num', 'rewardcue_odor_dur', 'rew_size', 'drop_or_not', 'trialtype', 'excite_or_not'});
