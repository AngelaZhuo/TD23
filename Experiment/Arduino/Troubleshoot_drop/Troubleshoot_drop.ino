  ...
  switch (state) {
    ...
    //test vial 8 
       ...
       // == 0 means strings are equal
          ...
          else if (strcmp(argv[0],"x01_230614") == 0) { //sesond odd continueous multiple pump trigger
          digitalWrite(PumpTrig, HIGH);
          delay(85);
          digitalWrite(PumpTrig, LOW);
          delay(3);
          ...
          else if (strcmp(argv[0],"x01_230614_1") == 0) { //first odd continueous multiple pump trigger
          digitalWrite(PumpTrig, HIGH);
          delay(6);
          digitalWrite(PumpTrig, LOW);
          delay(1);
          ...
          else if (strcmp(argv[0],"x01_230614_2") == 0) { //sesond odd continueous multiple pump trigger
          digitalWrite(PumpTrig, HIGH);
          delay(1);
          digitalWrite(PumpTrig, LOW);
          delay(3);
          ...
          else if (strcmp(argv[0],"x01_230614_3") == 0) { //third odd continueous multiple pump trigger
          digitalWrite(PumpTrig, HIGH);
          delay(11);
          digitalWrite(PumpTrig, LOW);
          delay(1);
...
case 100:
      ...
      ////Laser 1////
        ...
        if (laser_pattern == 1) {        //laser on continuously, for testing 
        ...
        if (laser_pattern == 4) {        //MSN tagging 1s, 5 Hz, 10ms 
        ...
        if (laser_pattern == 5) {        //MSN inhibition 2s pulse, once
          digitalWrite(OptRedTrig, HIGH);
          delay(2000);
          digitalWrite(OptRedTrig, LOW);
          }
